import { UserCircle2, Mail, Shield, Users, Calendar, CheckCircle2, XCircle } from "lucide-react";
import {
    Card,
    CardContent,
    CardDescription,
...
export default async function ProfilePage() {
    ...
    const roleColors: Record<string, string> = {
        ...
        TEAM_LEADER: "bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400",
    ...
    return (
        <div className="p-6 space-y-6 max-w-5xl mx-auto">
            ...
            <Card className="shadow-lg border-0">
                ...
                <CardContent>
                    <ProfileUpdateForm user={{ ...user.toJSON(), profile: (user as any).profile ?? null }} />
                </CardContent>
            </Card>
        </div>
    );
