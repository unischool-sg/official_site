...
export default function ProfileUpdateForm({ user }: ProfileUpdateFormProps) {
    ...
    return (
        <form onSubmit={(e) => { handleProfileUpdate(e, router, setIsLoading, setIsError); }} className="space-y-6">
            {isError && (
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center space-x-2">
                        <input
                            ...
                            id="isPublic"
                            name="isPublic"
                            defaultChecked={user.profile?.isPublic || false}
                            disabled={isLoading}
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>PNG、JPEG、GIF形式、5MB以下</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                    {avatarPreview && (
